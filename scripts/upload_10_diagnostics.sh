...
#########################################################################################
#
#  Compile + upload example 10 (DeviceInfoAndDiagnostics) to a connected Arduino Uno R4.
#
#  Usage:
#    ./scripts/upload_10_diagnostics.sh              # auto-detect port, Uno R4 Minima
#    ./scripts/upload_10_diagnostics.sh --wifi       # Uno R4 WiFi target
#    PORT=/dev/cu.usbmodemXXXX ./scripts/upload_10_diagnostics.sh
#    FQBN=arduino:renesas_uno:unor4wifi ./scripts/upload_10_diagnostics.sh
#
...
SKETCH="examples/10.DeviceInfoAndDiagnostics"
...
echo "[OK] Uploaded $SKETCH to $PORT  (open Serial Monitor at 57600 baud)"
